...
namespace GGemCo2DSimulationEditor
{
    ...
    /// </summary>
    public class SettingScriptableObjectSimulation : DefaultAddressable
    {
        ...
        public SettingScriptableObjectSimulation(AddressableEditorSimulation addressableEditorSimulationWindow)
        {
        ...
        public void OnGUI()
        {
            ...
            if (GUILayout.Button(Title, GUILayout.Width(_addressableEditorSimulation.buttonWidth), GUILayout.Height(_addressableEditorSimulation.buttonHeight)))
            {
                Setup();
            }
        }
        ...
        private void Setup()
        {
            ...
            foreach (var addressableAssetInfo in ConfigAddressableSettingSimulation.NeedLoadInLoadingScene)
            {
