...
namespace GGemCo2DSimulationEditor
{
    ...
    public class SettingGrowth : DefaultAddressable
    {
        ...
        private void Setup()
        {
            ...
            Dictionary<int, StruckTableSimulationGrowth> dictionary = _addressableEditorSimulation.tableSimulationGrowth.GetDatas();
            ...
            foreach (KeyValuePair<int, StruckTableSimulationGrowth> outerPair in dictionary)
            {
